  ...
  return (
    <div>
      ...
      <header className="header">
        {/* Logo and Title */}
        <a href="/stall" className="navbar-logo">
        ...
        <div className={`nav-links ${isMobile ? "hidden" : ""}`}>
          <ul>
            <li>
              <button onClick={() => navigate("/stall")}>Home</button>
            </li>
            <li>
              <button onClick={() => navigate("/checkout")}>Live Queue</button>
            </li>
            <li>
              <button onClick={() => navigate("/orderhistorytest")}>
                Order History
              </button>
            </li>
          </ul>
        ...
        {isMobile && (
          <div
            ...
            onClick={navigateToViewProfile} // Navigate to EditProfile on click
          >
            <img
